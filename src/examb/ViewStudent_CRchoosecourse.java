 ...
 * @author bushra
 */
public class ViewStudent_CRchoosecourse extends javax.swing.JFrame {

    /**
     * Creates new form ViewStudent_CRchoosecourse
     */
    public ViewStudent_CRchoosecourse() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewStudent_CRchoosecourse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewStudent_CRchoosecourse().setVisible(true);
            }
        });
    }
