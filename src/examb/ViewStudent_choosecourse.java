 ...
 * @author bushra
 */
public class ViewStudent_choosecourse extends javax.swing.JFrame {

    /**
     * Creates new form ViewStudent_choosecourse
     */
    public ViewStudent_choosecourse() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewStudent_choosecourse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewStudent_choosecourse().setVisible(true);
            }
        });
    }
